...
def main():
    ...
    home_images = (
        [(abs_url("/assets/images/logo-color-placeholder.png"), f"{cfg['site_name']} - game logo"),
         ...
         (abs_url("/assets/images/gifs/Webpage_Overworld_alt.mp4"), f"{cfg['site_name']} gameplay - exploring an isometric land"),
         (abs_url("/assets/images/gifs/Webpage_Puzzle.mp4"), f"{cfg['site_name']} gameplay - solving a puzzle")]
